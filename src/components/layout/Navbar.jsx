...
const Navbar = () => {
    ...
    return (
        <nav className="bg-blue-950 shadow-md py-4 pl-6 pr-16 flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-6 relative">
                ...
                <NavLink to='/cart' className="text-white font-semibold hover:text-gray-300 flex items-center"><span className="rbg-red-700 text-white absolute py-[2.2px] px-[9px] top-[-10px] left-[201px] bg-black rounded-[50%]">{cart.length}</span><ShoppingCart />Cart</NavLink>
            </div>
